export function newAssignment(assignment, history) {
    ...
    return function(dispatch) {
      const url = 'https://athena-academics-api.herokuapp.com/assignments'
...
export function editAssignment(updatedAssignment, assignmentId, history) {
    ...
    return function(dispatch) {
      const url = `https://athena-academics-api.herokuapp.com/assignment/${assignmentId}/edit`
...
export function getAssignment(id){
  return function(dispatch){
    const url = `https://athena-academics-api.herokuapp.com/assignments/${id}`
...
export function copyAssignment(assignmentId){
  return function(dispatch){
    const url = `https://athena-academics-api.herokuapp.com/assignment/${assignmentId}/copy`
    const jwtToken = localStorage.getItem("jwt")
    const headers = {
      method: 'post',
      headers: {
...
export function deleteAssignment(assignmentId){
  return function(dispatch){
    const url = `https://athena-academics-api.herokuapp.com/assignment/${assignmentId}/delete`
    const jwtToken = localStorage.getItem("jwt")
    const headers = {
      method: 'delete',
      headers: {
...
export function deleteAssigned(assignedId){
  return function(dispatch){
    const url = `https://athena-academics-api.herokuapp.com/assigned/${assignedId}/delete`
    const jwtToken = localStorage.getItem("jwt")
    const headers = {
      method: 'delete',
      headers: {
...
export function submitAssignment(answers, assignmentId){
  return function(dispatch){
    const url = `https://athena-academics-api.herokuapp.com/submitassignment/${assignmentId}`
...
export function getTeacherAssignments(id){
    return function(dispatch){
    const url = `https://athena-academics-api.herokuapp.com/users/${id}/assignments`
...
export function getStudentAssignments(id){
    return function(dispatch){
    const url = `https://athena-academics-api.herokuapp.com/users/${id}/assignedassignments`
...
export function assign(students, assignments, dueDate) {
    return function(dispatch){
      const url = `https://athena-academics-api.herokuapp.com/assignments/assign`
...
export function getAllIssuedAssignments(teacherId){
    return function(dispatch){
    const url = `https://athena-academics-api.herokuapp.com/users/${teacherId}/studentsassignments`
...
export function getSubmittedAssignment(issuedAssignmentId){
    return function(dispatch){
    const url = `https://athena-academics-api.herokuapp.com/submitted/${issuedAssignmentId}`
...
export function finalizeScore(finalParams,issuedAssignmentId){
    return function(dispatch){
    const url = `https://athena-academics-api.herokuapp.com/submitted/${issuedAssignmentId}/finalize`
