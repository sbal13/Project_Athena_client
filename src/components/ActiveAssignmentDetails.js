...
const ActiveAssignmentDetails = ({details, start, started, openModal, over, seeResults, readOnly})=>{
	...
	return (
		<Card>
			...
			{started ? <Button color="orange" disabled={over || readOnly} onClick={openModal}>finished!</Button> : <Button onClick={start} color="teal">{readOnly ? "view"  : "start!"}</Button>}
