...
class StudentScatterChart extends React.Component {
	...
	render(){
		...
		const teacherOptions = [{key: this.props.teachers.length, value: "All teachers", text: "All teachers"}, ...this.props.teachers.map((teacher,index) => ({key: index, value: teacher.id, text: teacher.username}))]
